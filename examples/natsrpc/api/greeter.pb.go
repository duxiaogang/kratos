...
const file_greeter_proto_rawDesc = "" +
	"\n" +
	"\rgreeter.proto\x12\x03api\x1a\rnatsrpc.proto\"\"\n" +
	...
	"\x05Empty2i\n" +
	"\aGreeter\x12.\n" +
	"\bSayHello\x12\x11.api.HelloRequest\x1a\x0f.api.HelloReply\x12.\n" +
	"\x06Notify\x12\x12.api.NotifyRequest\x1a\n" +
	".api.Empty\"\x04\xc0\x93\x01\x01B9Z7github.com/go-kratos/kratos/v2/examples/natsrpc/api;apib\x06proto3"
